(function payment() {
  var d = document,
	  ...
	  ccNumber2 = ccForm.querySelector('#cardnumber2'),
      cNumber = d.querySelectorAll('.card-number'),
	  cNumber2 = d.querySelectorAll('.card-number2'),
  ...
  function init() {
    ...
    addEvent(ccNumber, 'blur', function() {
	 ...
	 addEvent(ccNumber2, 'focus', function() {
      cNumber2[0].classList.add('glow');
    });
    addEvent(ccNumber2, 'blur', function() {
      cNumber2[0].classList.remove('glow');
    });
